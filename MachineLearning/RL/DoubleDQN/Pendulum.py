...
class DQN:
    ...
    def update(self, transition_dict):
        ...
        # 下个状态的最大Q值
        if self.dqn_type == "DoubleDQN":  # INFO: DQN 与 Double DQN 的区别
...
def dis_to_con(discrete_action, env, action_dim):
    ...
    actoin_upbound = env.action_space.high[0]  # 连续动作的最大值
        ...
        with tqdm(total=int(num_episodes / 10), desc="Iteration %d" % i) as pbar:
            for i_episode in range(int(num_episodes / 10)):
                ...
                while not done:
                    ...
                    max_q_value_list.append(max_q_value)  # 保存每个状态的最大 Q 值
...
action_dim = 11  # 将连续动作分成 11 个离散的动作
agent = DQN(
    state_dim,
    hidden_dim,
    action_dim,
